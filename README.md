...
& this is the career change I've been dreaming of. I had an enriching career in education learning support, which could be very challenging but was highly collaborative & rewarding work, using technology as part of the process of assisting people with their learning support & education needs. I have also worked within the rigorous areas of video subtitling & library-cataloguing services.

**I am very excited to progress in a new career in coding** 
which I discovered after completing free courses during lock-down. This interest & passion to learn led me to joining the Makers remote course and discovering how much I enjoy investigating & contributing to code solutions both solo & in team situations & I continue to investigate coding challenges & build projects with the assistance of tutorials & varied web sources.
...
- **Makers Academy**
Before Makers I completed Code Academy courses in Ruby & Javascript & then delved deep into the full 
stack with Makers, & have since employed follow-up courses to help the consolidation process including exploring the Odin Project, Udemy courses in React & various online resources
Makers gave me grounding in the fundamentals of full-stack development.

I have been working to really embed my knowledge and get myself in a position to enter the job market and looking for collaborative developer roles.

The Makers course helped me to learn with a lot of self-motivated research in how to start constructing apps that fulfilled a given criteria from the ground up, from user stories using thorough planning & domain modelling.
...
| ---------------------------- | ----------------- | ---------------------- |
| **Kirill: A Distributed Music Instrument** https://github.com/david-ewan-campbell/kirill | Ongoing collaborative project to build a rigorously tested app that provides a performance platform for users to play music online & for others to listen-in to live performances | Ruby, RSPEC, Javascript, Jest, HTML & CSS, Shell scripting, Sinatra, Railway for Deployment|
| **React Native/EXPO Counter App built using TDD** https://github.com/david-ewan-campbell/Counter-App-2-Jest-TDD-React-Native-with-EXPO | Self-motivated challenge to build a simple app with Jest testing that uses some more unfamiliar languages & tech such as React-Native & migrating Javascript to Typescript & launched in the EXPO mobile app | Javascript/Typescript, Jest, React-Native, EXPO |
| **Bank Tech-Test** https://github.com/david-ewan-campbell/bank-Tech-Test-Javascript | Self-driven challenge to build a bank app with rigorous incremental TDD that can be required, instantiated and run in Node REPL. | Javascript, Jest, ESlint, Excalidraw for Domain Modelling, Gitignore |
...
- **Alan Campbell Chartered Architects**  (Various periods of work up to the present)
...
- **I have been a musician for many years and have recordings released with many different projects, including 2 albums I helped record mostly remotely in lock-down, both released on an American label over the last 2 years and also have 2 Live BBC radio sessions amongst my musical achievements.**
